...
export default function LoginPage() {
  ...
  return (
    <AuthCard
      title="Sign in"
      subtitle="Use your TrackFlow account to reach the internal operations workspace."
      footer={
        <>
          No account yet?{" "}
          <Link href="/register" className="font-semibold text-[color:var(--brand-primary)] hover:underline">
            Create one
          </Link>
        </>
      }

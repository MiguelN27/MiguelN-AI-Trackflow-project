...
/** Shared with `uis/backoffice`: same product, same API, same token. */
 ...
 * Not `/`, which is the public corporate page and needs no session.
 */
export const DEFAULT_AUTHENTICATED_PATH = "/candidates";
